...
(Generic quick sort ) Write the following two generic methods using quick sort. The first method sorts the elements using the Comparable interface and the second uses the Comparator interface. Use Exercise23_03.javaPreview the documentPreview the document as the test class.

You will also need to download the GeometricObject, Circle, and GeometricObjectComparator classes.
*/
...
public class Exercise23_03 {
  ...
  private static <E> int partition(E[] list, int first, int last, Comparator<? super E> comparator) {
    ...
    // include the comparator parameter
   ...
   private static <E> void quickSort(E[] list, int first, int last, Comparator<? super E> comparator) {
    ...
    // Create methods for the comparable (new partition and quicksort(int)---
