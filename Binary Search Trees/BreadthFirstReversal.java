...
public class BreadthFirstReversal {
  public static void main(String[] args) {
    new BreadthFirstReversal();
  }

  public BreadthFirstReversal() {
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public int height(TreeNode<E> root) {
      ...
      //if statement that compares root to null
      if(root == null) return 0;
      // return the max of the left and right roots
    ...
    public void breadthFirstTraversal() {
      ...
      //create a while loop that traverses the queue
      while(!queue.isEmpty()){
