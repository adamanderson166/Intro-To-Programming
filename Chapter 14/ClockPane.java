...
public class ClockPane extends Pane {
	...
	private void paintClock() {
		...
		// Boolean accessor hourHandVisible
		public boolean getHourHand() {
			return hourHandVisible;
		}
		
		// Boolean mutator method hour hand
		public void setHourHand(boolean v) {
			this.hourHandVisible = v;
			paintClock();
		}
		
		// Boolean accessor minuteHandVisible
		public boolean getMinuteHand() {
			return minuteHandVisible;
		}
		
		// Boolean mutator method minute hand
		public void setMinuteHand(boolean v) {
			this.minuteHandVisible = v;
			paintClock();
		}
		
		// Boolean accessor secondHandVisible
		public boolean getSecondHand() {
			return secondHandVisible;
		}
		
		// Boolean mutator method second hand
		public void setSecondHand(boolean v) {
			this.secondHandVisible = v;
			paintClock();
		}
